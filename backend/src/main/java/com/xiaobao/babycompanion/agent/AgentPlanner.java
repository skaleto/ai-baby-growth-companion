...
public class AgentPlanner {
    ...
    private static final String PLANNER_SYSTEM_PROMPT = """
            ...
            用户可能用 12 小时制或“刚才/刚刚”等相对说法描述时间；以 currentDateTime 为“现在”锚点，解析成离现在最近、且不晚于现在的那个时刻（可跨到昨天，例如凌晨 00:20 说“刚才11:30”指昨天 23:30，而非今天或昨天中午）。除非明确说将来，否则不要解析到 currentDateTime 之后。
