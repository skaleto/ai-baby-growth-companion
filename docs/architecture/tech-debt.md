...
> 更新:2026-06-12 · 来源:2026-06-10 ~ 06-12 相册/预览/性能三轮排障战役的完整复盘
...
| # | 债项 | 影响面 | 优先级 | 状态 |
|---|------|--------|--------|------|
| D1 | App.tsx 单体组件(~9800 行 / 98 useState / 全 Tab 一棵树) | 全局性能、可维护性 | **P0** | 已局部缓解,待拆分 |
| D2 | 服务端缩略图缺失(老照片网格解码原图) | 相册性能、流量 | **P0** | 未开工 |
